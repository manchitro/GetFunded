...
module.exports ={
	...
	insertEvent: function(user, callback){
		var sql = "INSERT INTO `events` VALUES ('','"+user.eventName+"' ,'"+user.creatorId+"', '"+user.eventPicture+"' ,  '"+user.description+"','"+user.categoryId+"' , '"+user.goalAmount+"' ,'"+user.goalDate+"' ,'1', current_timestamp() )";
